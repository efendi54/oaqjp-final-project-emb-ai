...
def emotion_detector(text_to_analyse:str):
    ...
    dominant_emotion_score = report['anger']
    for e in ['disgust', 'fear', 'joy', 'sadness']:
        if report[e] > dominant_emotion_score:
            report['dominant_emotion'] = e
            dominant_emotion_score = report[e]
    return report
